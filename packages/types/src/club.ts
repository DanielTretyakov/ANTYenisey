...
export interface ClubSettings {
  ...
  /**
   * Телефон и почта клуба — их видит посетитель на странице клуба.
   *
   * Необязательные: клуб может работать без общего номера. Телефон — в том же
   * формате, что у человека («+79991234567»): он уходит в ссылку `tel:`.
   */
  phone: string | null;
  email: string | null;
