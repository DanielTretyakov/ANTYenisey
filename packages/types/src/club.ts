 ...
 *
 * Тому же типу турнира соответствует `Tournament`, и различий с ним ровно три,
 * и все три существенные: у занятия известно окончание (турнир идёт, пока
 * идёт), есть тренер и есть лимит мест. Из-за лимита запись на занятие —
 * не такая же операция, как регистрация на турнир: её нужно сериализовать.
 */
