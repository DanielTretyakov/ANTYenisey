 ...
 *
 * Родитель переключателем смотрит и отменяет записи своего ребёнка младше 14.
...
export default function MyBookingsPage() {
  ...
  return (
    <AppShell>
      ...
      {family.selfIsChild && (
        <Alert tone="info">Отменить запись до 14 лет может родитель — или администратор клуба.</Alert>
      )}
