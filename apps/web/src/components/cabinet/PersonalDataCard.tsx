 ...
 * и опечатка закрыла бы человеку вход; дата рождения решает правила до 16
 * лет, и правка её самим ребёнком вывела бы его из-под опеки. До 16 лет ФИО и
  ...
  return (
    <>
      ...
      <p className="mt-4 text-[0.8125rem] text-text-subtle">
        До 16 лет данные меняет родитель или администратор клуба.
      </p>
    </>
  );
}
  ...
  return (
    <div className="mt-2 mb-4 rounded-control border border-border bg-surface-sunken px-4 py-3.5">
      ...
      <p className="mt-3 text-[0.8125rem] text-text-subtle">
        Почта — ваш логин, дата рождения решает правила до 16 лет. Их меняет администратор клуба.
      </p>
    </div>
  );
}
