...
/**
 * За кого правится профиль: ребёнка младше 14 — или свой (null).
 *
 ...
 * человек, а пока ему нет 14 — родитель (`forPerson`); клуб профиль не правит —
 * он проверяет разряд. Сам ребёнок младше 14 свой профиль только смотрит
 * (`readOnly`).
 *
...
function descriptionOf(
  ...
  if (readOnly) {
    ...
    return 'До 14 лет профиль правит закреплённый за вами родитель, а вы его смотрите.';
  }
  ...
  return profile && !profile.isPublic
    ? `До 14 лет страница игрока видна только ${forPerson ? 'ему, вам' : 'вам'} и администраторам ${forPerson ? 'его' : 'ваших'} клубов.`
